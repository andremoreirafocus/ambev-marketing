Prompt:  Leia todos os arquivos md. Crie um texto de apoio uma especie de index no arquivo Concorrentes.md explicando os niveis de concorrencia e apontando para os arquivo que contem os detalhes de cada nivel.
...
1. Mercado de bebidas — concorrência ampla e produtos substitutos

   Arquivo: [Concorrentes_bebidas.md](Concorrentes_bebidas.md)

   Apresenta o panorama da concorrência da Ambev em bebidas, incluindo grupos
   cervejeiros e empresas de bebidas não alcoólicas, como a Coca-Cola. Também
   contém uma comparação de marcas de cerveja por faixa de posicionamento.
...
2. Mercado de cervejas — concorrência dentro da categoria
   ...
   Arquivo: [Concorrentes_cervejas.md](Concorrentes_cervejas.md)

   Apresenta a estrutura competitiva do mercado brasileiro de cervejas,
   abordando participação de mercado, posicionamento das ofertas e
   estratégias de preço e distribuição.

   Neste nível, analisamos como as opções de cerveja disputam a preferência
...
a fontes verificáveis antes de serem utilizados na apresentação acadêmica.
